				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">관리자 /</span> 직책 관리
						</h4>
										...
										<div class="modal-dialog modal-dialog-centered"
											...
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="modalRegistTitle">직책 등록</h5>
													<!-- 닫기 버튼 -->
												...
												<div class="modal-body">
													<div class="row">
														<div class="col mb-3">
															<label for="depNameWithTitle" class="col-md-2 col-form-label-lg">직책
																명</label> <input type="text" id="depName" class="form-control col-form-label-lg"
													...
													<div class="row">
														<div class="col mb-3">
															<label for="depLevelWithTitle" class="col-md-2 col-form-label-lg">직책
																레벨</label> <input type="number" min="0" id="depLevel"
																class="form-control col-form-label-lg" placeholder="직책 레벨을 입력해주세요" />
														</div>
													</div>
										...
										<div class="modal-dialog modal-dialog-centered"
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="row">
														<div class="col mb-3">
															<label for="depNameWithTitle" class="col-md-2 col-form-label-lg">직책명</label>
															<!-- 직책명 입력  -->
															<input type="text" id="nameUpdate" class="form-control"
																placeholder="직책명을 입력해주세요" readonly />
														</div>
													</div>
													...
													<div class="row">
														<div class="col mb-3">
															<label for="depLevelWithTitle" class="col-md-2 col-form-label-lg">직책
																레벨</label> <input type="number" min="0" id="levelUpdate"
																class="form-control" placeholder="직책 레벨을 입력해주세요"
																readonly />
														</div>
													</div>
													<!-- 활성화여부 -->
...
function drawList(AdminDepList){
	...
	if(AdminDepList.length == 0){
		...
		content += '<tr>'
		content += '<td colspan="4"> 해당하는 직책이 없습니다. </td>'
		content += '</tr>'
		...
		for(i=0;i<AdminDepList.length;i++){
			...
			content +='<td id = "listIdx"><i class="fab fa-bootstrap fa-lg text-primary me-3"></i>'+AdminDepList[i].duty_idx+'</td>'; //직책번호
			content +='<td><a role="button" data-bs-toggle="modal" data-bs-target="#modalUpdate" id="facListNameA" onclick="getElem(this)"><strong id = "listName">'+AdminDepList[i].name+'</strong></a></td>';//직책명
			content +='<td id="listLevel">'+AdminDepList[i].level+'</td>' //직책레벨
...
function getElem(elem){
	...
	var listLevel =$(elem).closest('#drawListTr').find('#listLevel').text(); 
...
function modalUpdateForm(){
	var newTitle = "직책 수정";
	$("#modalUpdateTitle").html(newTitle); //상세보기 => 직책 수정 : 모달헤더변경
	$("#nameUpdate").prop('readonly',false); //직책명 reaonly 해제
	$("#levelUpdate").prop('readonly',false); //직책레벨 reaonly 해제
...
$('#modalUpdate').on('hidden.bs.modal', function () {
	...
	var newTitle = "상세보기";
	$("#modalUpdateTitle").html(newTitle); //직책 수정 => 상세보기 : 모달헤더변경
	$("#nameUpdate").prop('readonly',true); //직책명 reaonly
	$("#levelUpdate").prop('readonly',true); //직책 레벨 reaonly
