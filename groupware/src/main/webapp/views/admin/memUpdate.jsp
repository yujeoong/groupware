				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">사원 관리 /</span> 사원 수정
						</h4>
						...
						<div class="col-xl">
							<div class="card mb-4">
								...
								<div class="card-body" style="margin: 30px;">
									...
									<!-- 사원 등록 포맷 -->
									<form action="/admin/memUpdate.do" method="post"
										...
										<div class="row g-5">
											...
											<div class="col" style="float: left; width: 40%;">
												...
												<div class="mb-3">
													<label class="col-md-2 col-form-label-lg"
														for="basic-icon-default-fullname">생일</label>
													<div class="input-group input-group-merge">
														<span id="basic-icon-default-fullname2"
															class="input-group-text"><i class="bx bx-cake"></i></span>

														<input type="date" id="birthdayRegist"
													...
													<div class="input-group input-group-merge">
														...
														<div class="input-group">
															...
															<input type="text" id="supervSelectName"
																class="form-control" placeholder="직속 상급자를 선택해주세요"
												...
												<!-- 직속 배치 여부 라디오 -->
												<input type="hidden" id="stackRegist" name="stack"
													value="${member.stack}" />
												<div class="row g-2">
													<div class="mb-3">
														<div>
															<div class="row gy-3">
																<div class="row g-3">
																	<small class="ext-light fw-semibold d-block col-form-label-lg">직속
																		배치 여부</small>
																	<!-- Y -->
																	<div style="text-align: center;">
																		<div class="form-check form-check-inline mt-3">
																			<input class="form-check-input" type="radio"
																				...
																				onchange="getStack()" /> <label
																				class="form-check-label" for="inlineRadio1">YES</label>
																		</div>
																		<!-- N -->
																		<div class="form-check form-check-inline">
																			<input class="form-check-input" type="radio"
																				name="activeRegist" id="activeN" value="N"
																				onchange="getStack()" /> <label
											...
											<div class="col"
												...
												<div class="mb-3">
													...
													<div class="input-group input-group-merge">
														...
														<input type="hidden" id="depOld" name="dep_idx"
															value="${member.dep_idx}" /> <select id="depRegist"
															class="form-select depOptionList"
															onchange="plusText(this)">
												...
												<div class="mb-3">
													...
													<div class="input-group input-group-merge">
														...
														<input type="hidden" id="posOld" name="pos_idx"
															value="${member.pos_idx}" /> <select id="posRegist"
															class="form-select" onchange="plusText(this)">
												...
												<div class="mb-3">
													...
													<div class="input-group input-group-merge">
														...
														<input type="hidden" id="dutyOld" name="duty_idx"
															value="${member.duty_idx}" /> <select id="dutyRegist"
															class="form-select" onchange="plusText(this)">
												...
												<!-- 부서/직책/직급 변경사항 -->
												<div class="col mb-0">
													<label for="facTextarea" class="col-md-2 col-form-label-lg">비고</label>
													<textarea class="form-control" id="depComment" rows="1"
														name="comment" style="resize: none;" disabled></textarea>
												</div>
												...
												<div class="mb-3" style="padding: 20px 0 0 0;">
													<div class="col">
														<label class="col-form-label-lg"
															for="basic-icon-default-fullname">서명
															이미지 </label> <img id="signPreview"
															src="/photo/${sign.new_file_name}"
															style="width: auto;display: block;height: 100px;margin: auto;padding: 5px;" />
										...
										<div class="float-end">
											<button type="button" class="btn btn-outline-primary"
												onclick="location.href='/admin/memDetail.move?mem_id=${member.mem_id}'">취소</button>
