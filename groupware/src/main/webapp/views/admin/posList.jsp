				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">관리자 /</span> 직급 관리
						</h4>
										...
										<div class="modal-dialog modal-dialog-centered"
											...
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="modalRegistTitle">직급 등록</h5>
													<!-- 닫기 버튼 -->
												...
												<div class="modal-body">
													<div class="row">
														<div class="col mb-3">
															<label for="depNameWithTitle" class="col-md-2 col-form-label-lg">직급
										...
										<div class="modal-dialog modal-dialog-centered"
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="row">
														<div class="col mb-3">
															<label for="depNameWithTitle" class="col-md-2 col-form-label-lg">직급명</label>
															<!-- 직급명 입력  -->
															<input type="text" id="nameUpdate" class="form-control"
																placeholder="직급명을 입력해주세요" readonly />
														</div>
													</div>
													<!-- 활성화여부 -->
													<div class="col mb-0">
...
function drawList(AdminDepList){
	...
	if(AdminDepList.length == 0){
		...
		content += '<td colspan="4"> 해당하는 직급이 없습니다. </td>'
		content += '</tr>'
		...
		for(i=0;i<AdminDepList.length;i++){
			...
			content +='<td id = "listIdx"><i class="fab fa-bootstrap fa-lg text-primary me-3"></i>'+AdminDepList[i].pos_idx+'</td>'; //직급번호
			content +='<td><a role="button" data-bs-toggle="modal" data-bs-target="#modalUpdate" id="facListNameA" onclick="getElem(this)"><strong id = "listName">'+AdminDepList[i].name+'</strong></a></td>';//직급명
...
function modalUpdateForm(){
	var newTitle = "직급 수정";
	$("#modalUpdateTitle").html(newTitle); //상세보기 => 직급 수정 : 모달헤더변경
	$("#nameUpdate").prop('readonly',false); //직급명 reaonly 해제
...
$('#modalUpdate').on('hidden.bs.modal', function () {
	...
	var newTitle = "상세보기";
	$("#modalUpdateTitle").html(newTitle); //직급 수정 => 상세보기 : 모달헤더변경
	$("#nameUpdate").prop('readonly',true); //직급명 reaonly
