        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
			...
			<div class="container-xxl flex-grow-1 container-p-y">
               <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">아티스트 /</span> 상세보기</h4>
			...
			<div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card" style="width: 155%;">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary"><span class="fw-bold">${title}</span></h5><br>
                          <span class="fw-semibold d-block mb-1">발매일 &nbsp;${date}</span>
                          <span class="fw-semibold d-block mb-1">장 르   &nbsp;&nbsp;&nbsp;${jangree}</span>
                          <span class="fw-semibold d-block mb-1">발매사 &nbsp;${company}</span>
                          <span class="fw-semibold d-block mb-1">기획사 &nbsp;${agency}</span>
                        </div>
                      </div>
