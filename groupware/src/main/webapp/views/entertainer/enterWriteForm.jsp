		...
		<div class="layout-container">
			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">연습생,아티스트 /</span> 등록하기</h4>
					
					
					
					
			<form action="/entertainer/enterRegist.do" method="POST" enctype="multipart/form-data" id="ent_regist_form">
				<div class="card mb-4">
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <div class="button-wrapper">
                            <input class="form-control" type="file" id="input-image" name="photo"/>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                        <input class="form-control" type="text" id="a" name="name"/>
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="date" id="b" name="birth"/>
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">혈액형</label>
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="c" name="blood"/>
                        </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="d" name="height"/>
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="e" name="weight"/>
                        </div>
                      </div>
                     ...
                     <div class="mb-3 row" id = "art">
                        ...
                        <input class="form-control" type="date" name="debut_date"/>
               ...
               <div class="row">
				...
				<div class="modal-dialog modal-dialog-centered modal-lg"
					...
					<!-- 모달 끝 -->
                         ...
                         <input class="form-control" type="text" name="stage_name" placeholder="예명"/>
                        <label for="html5-text-input" class="col-md-2 col-form-label">*소속그룹</label><br>
                          <c:forEach items="${artistGroup}" var="group">
                        <div>  
                            <input class="form-check-input" id="group" type="radio" name="artg_idx" value="${group.artg_idx}"/>
                            <label for="html5-text-input" class="col-md-2 col-form-label">${group.artg_name}</label>
                         </div>
                           </c:forEach>
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="h" name="hobby"/>
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">특기</label>
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="i" name="skill"/>
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="j" name="language"/>
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" id="k" name="enter_com"/>
                        </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="date" id="l" name="cont_start_date"/> ~ 
                          <input class="form-control" type="date" id="m" name="cont_end_date"/>
                          <input class="form-control" type="text" id="n" placeholder="이력내용을 입력해주세요." name="con_com"/> <br>
                         </div>
                      </div>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                        <div>
                          <input class="form-control" type="date" id="o" name="career_start_date[]"/> ~ 
                          <input class="form-control" type="date" id="p" name="career_end_date[]"/>
                          <input class="form-control" type="text" id="q" placeholder="활동내용을 입력해주세요." name="career_content[]"/> <br>
                        </div>
...
/* $("#input_check").click(function(){
	 if($('#html5-text-input').val()=='' || $('#group').val()=='' || $('#input-image').val()=='' || selMemList.length < 1){
		alert("공백은 안됩니당");
		return false;
	 }else{

		 $("#ent_regist_form").submit();
	 }
}); */ 

$("#input_check").click(function(){
    if($('#input-image').val()=='' || $('#a').val()==''|| $('#b').val()==''|| $('#c').val()==''||
            $('#d').val()==''|| $('#e').val()==''|| $('#h').val()==''|| $('#i').val()==''|| $('#j').val()==''|| 
            $('#k').val()==''|| $('#l').val()==''|| $('#m').val()==''||
            $('#n').val()==''|| $('#o').val()==''|| $('#p').val()==''|| $('#q').val()==''){
		alert("공백은 안됩니당");
		return false;
	 }else{
	...
	*/
	...
	function drawSelMemList(list) {
		...
		if(selMemList.length<1){
			...
			content += '<li class="list-group-item d-flex justify-content-between align-items-center" id="mem">';
	...
	function drawConfirmMemList(list) {
		...
		for (var i = 0; i < list.length; i++) {
			...
			content += '</div>';
			content += '</div>';
			content += '<input type="hidden" id="mem" name="mem_id" value="'+list[i].mem_id+'"/>';
		}
