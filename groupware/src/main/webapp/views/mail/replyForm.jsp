          ...
          <div class="content-wrapper">
			...
			<div class="container-xxl flex-grow-1 container-p-y">
				...
				<%
					...
					if(request.getParameter("mail_idx") != null){
						mail_idx = Integer.parseInt((request.getParameter("mail_idx")));
					}
				%>	
				
				<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">쪽지 /</span> 답장하기</h4>
								...
								<div class="card mb-4">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="title" name="title" value="Re: ${list.title}" placeholder="제목을 입력해 주세요." />
											</div>
										</div>
										...
										<div class="mb-3 row">
											<label for="html5-text-input" class="col-md-2 col-form-label-lg">보낸사람</label>
												<div class="col-md-10">
													<div>
														<input type="text" class="form-control" name="sender_id" id="sender_id" value="${sessionScope.loginId}" readonly />
													</div>
												</div>
										</div>
										...
										<div class="mb-3 row">
											<label for="html5-text-input" class="col-md-2 col-form-label-lg">받는사람</label>
												<div class="col-md-10">
													<div>
														<input type="text" class="form-control" value="${replyRcp.dept_name} ${replyRcp.mem_name} ${replyRcp.pos_name}" readonly />
														<input type="hidden" id="receiver_id" name="receiver_id" value="${replyRcp.sender_id}" readonly />
													</div>
												</div>
										</div>
										...
										<div id="form_content" style="display: none">
												<br><br><br><br><hr>
												<strong>From: </strong>${replyRcp.dept_name} ${replyRcp.mem_name} ${replyRcp.pos_name}<br>
												<strong>Sent: </strong>${list.date}<br>
												<strong>Subject: </strong>${list.title}<br>
												${list.content}</div>
										...
										<p style="height:10px;">&nbsp;</p>
											...
											<button type="button" class="btn btn-outline-primary float-end" style="margin-right: 10px;" onclick="location.href='../mail/detail.move?mail_idx=${list.mail_idx}'">취소</button>
