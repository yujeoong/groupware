						...
						<!-- <form id="scheWriteForm" class="mb-3" action="/schedule/regist.do" method="POST"> -->
							...
							<div class="card mb-4">
								...
								<div class="demo-inline-spacing ">
									...
									<button type="button" onclick="scheSubmit(); return false;" class="btn btn-primary float-end">등록</button>
					            </div>
							</div>
						<!-- </form> -->
...
var mem_id = url.substring(url.indexOf('?') + 1).split('=')[1]; // 관리자가 일정 추가할 id 
		...
		if(result){
			...
			$.ajax({
				...
				success: function(data){
					...
					location.href = "/admin/memDetail.move?mem_id="+mem_id;
				},
				error: function(e){
					console.log(e);
				} 
